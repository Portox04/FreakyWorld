...
public class UsuarioService {
    ...
    @Transactional
public Usuario registrarClienteGoogle(String nombre, String correo) {
    ...
    if (usuarioExistente.isPresent()) {
        ...
        boolean tieneRolCliente = usuarioRolRepository
                .existsByUsuarioIdUsuarioAndRolIdRol(usuario.getIdUsuario(), rolCliente.getIdRol());
        ...
        boolean tieneCarrito = carritoRepository.findByUsuarioIdUsuario(usuario.getIdUsuario()).isPresent();
    ...
    usuario.setNombre(nombre != null && !nombre.isBlank() ? nombre : "Usuario Google");
